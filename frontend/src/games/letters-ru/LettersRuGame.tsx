...
export default function LettersRuGame() {
  ...
  function choose(ch: string) {
    ...
    if (correct) {
      ...
      newScore = score + 1;
      setScore(newScore);
      setToast({ text: 'Верно! Это буква «' + current + '»', kind: 'good' });
    } else {
      sfx(false);
  ...
  function finish(finalScore: number) {
    ...
    saveBest('letters-ru', finalScore);
  }
  ...
  return (
    <>
      <header className="bar">
        ...
        <span className="title">Учим буквы</span>
